...
Il s'agit d'un pointeur intéligent apparu en C++03 et le premier proposé par la stl.
...
Ce pointeur à le même fonctionnement que auto_ptr, mais corrigé de sa faille de sécurité. Cela en interdisant la duplication (pas de copie possible). Le pointeur est donc unique (d'ou son nom) !
